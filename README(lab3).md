...
Цель работы
Освоение принципов объектно-ориентированного программирования на C++, включая создание классов. Разработка и тестирование классов для представления различных сущностей.
